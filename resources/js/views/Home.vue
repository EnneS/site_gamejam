        ...
        <section id="intro">
          <div class="container intro-container text-white">
            ...
            <p class="h5 mb-4 w-75">
              ...
              La GameJam est une semaine organisée par l'IUT2 où tous les étudiants du semestre S3 et S2D s'affronteront dans une lutte acharnée dans le but de créér un jeu vidéo avec un langage de programmation et un thème donnés.<br/>
            ...
            <div v-for="year in years" v-if="year.games.length > 1">
              ...
              <div class="row d-flex justify-content-between">
                <div class="col" v-for="game in year.games">
                  <img :src="'storage/games/' + year.year + '/' + game.hash + '/jaquette.png'" alt="" class="game-jaquette">
                  <p>{{ game.name }}</p>
                </div>
              </div>
            </div>
...
<script>
import footerGamejam from '../components/footer/footer.vue'

export default {

  components:{footerGamejam},
